...
<html>
   <head>
      ...
      <link rel="shortcut icon" href="images/issat-logo.png" type="">
         ...
         <header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="#"><img width="250" src="images/issat-logo.png" alt="#" /></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                       ...
                       <a class="nav-link" href="{{route('collab.formPerso')}}">Formation Personnalisée</a>  </li>
                        <li class="nav-item">
