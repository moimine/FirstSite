                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                       ...
                       <li class="nav-item dropdown">
                        <a class="nav-link" href="{{route('entre.all')}}">Toute les entreprises</a> 
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="{{route('entre.order')}}">Les commandes</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="{{route('entre.collab')}}">Les collaborations a évaluer</a>
                        </li>
                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 ...
                                 <p>
                                    Tout savoir sur les relations ISSAT-ENTREPRISE.
                                 </p>
                              </div>
                           </div>
                        </div>
